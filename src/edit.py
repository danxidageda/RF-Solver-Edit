...
def main(
    ...
    while opts is not None:
        ...
        for x in batch_x:
            x = x.unsqueeze(0)
            #lyw
            source_img_name = os.path.basename(args.source_img_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', default='flux-dev', type=str,
                        help='flux model')
    parser.add_argument('--source_img_dir', default='../all_pictures_resize/A black church.jpg', type=str,
                        help='The path of the source image')
    parser.add_argument('--source_prompt', type=str,default="A black church",
                        help='describe the content of the source image (or leaves it as null)')
    parser.add_argument('--target_prompt', type=str,default="An ice church",
