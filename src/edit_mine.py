...
def main(
    ...
    for picture_file in picture_files:
        ...
        target_prompt = mapping[source_prompt]
        source_prompt = ""
        init_image = None
        ...
        while opts is not None:
            ...
            for x in batch_x:
                ...
                output_name = os.path.join(output_dir, target_prompt + ".jpg")
                #lyw
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', default='ablation/new_output/output_1_solver_edit_3_20_3_k_injection', type=str,
